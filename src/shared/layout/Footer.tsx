      ...
      <div className="w-full max-w-[85rem] py-6 px-4 sm:px-6 mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
          ...
          <div className="col-span-1">
            ...
            <div className="mt-3 grid space-y-3">
              ...
              <p><a
                className="inline-flex gap-x-2 text-gray-400 hover:text-gray-200 focus:outline-hidden focus:text-gray-200 dark:text-neutral-400 dark:hover:text-neutral-200 dark:focus:text-neutral-200"
                href="#">Changelog</a>
                <sup className="ms-0.5 text-xs bg-blue-700 text-white py-0.5 px-1 rounded-lg">TBD</sup></p>
              <p><a
                className="inline-flex gap-x-2 text-gray-400 hover:text-gray-200 focus:outline-hidden focus:text-gray-200 dark:text-neutral-400 dark:hover:text-neutral-200 dark:focus:text-neutral-200"
                href="#">Docs</a>
                <sup className="ms-0.5 text-xs bg-blue-700 text-white py-0.5 px-1 rounded-lg">TBD</sup></p>
          ...
          <div className="col-span-2">
            ...
            <form>
              <div
                className="mt-4 flex flex-col items-center gap-2 sm:flex-row sm:gap-3 bg-white rounded-lg p-2 dark:bg-neutral-900">
        ...
        <div className="mt-5 sm:mt-6 grid gap-y-2 sm:gap-y-0 sm:flex sm:justify-between sm:items-center">
          ...
          <div>
            <a
              ...
              href="mailto:dmytro.m.vasylenko@gmail.com">
            ...
            <a
              className="size-10 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent text-white hover:bg-white/10 focus:outline-hidden focus:bg-white/10 disabled:opacity-50 disabled:pointer-events-none"
              href="https://github.com/vasylenko-dmytro">
              <svg className="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                   fill="currentColor" viewBox="0 0 16 16">
                <path
